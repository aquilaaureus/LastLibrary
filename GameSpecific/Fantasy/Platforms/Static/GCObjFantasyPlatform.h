...
#define _GCOBJFANTASYPLATFORMS_H_
...
public:
	...
	////////////////////////////
	CGCObjFantasyPlatform( void )
		: CGCObjPlatform( )
	{}

	// declare the factory method to enable this to be created via CGCFactory_ObjSpritePhysics 
	GCFACTORY_DECLARE_CREATABLECLASS( CGCObjFantasyPlatform );

	virtual void VOnResourceAcquire( void ) override;

	virtual ~CGCObjFantasyPlatform()
	{};
};
